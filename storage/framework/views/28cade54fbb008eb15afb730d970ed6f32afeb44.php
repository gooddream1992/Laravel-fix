                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-6 col-md-12 ">
                            <div class="zigzag-red-box ">
                                ...
                                <?php echo $data7->description; ?><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12  order-lg-1 ">
                            <div class="zigzag-red-box">
                                ...
                                <?php echo $data8->description; ?><br><br>
                                <button class="btn red-small">Read More</button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('masters.frontmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\honeyluxe-front\resources\views/frontend/provider/frontBecomeEscort.blade.php ENDPATH**/ ?>