        ...
        <div id="content">
            ...
            <section class="red-tab-sec">
                <ul class="nav nav-pills  nav-pills nav-justified" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link single active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><span class="sprint-user-icons"></span> Some Title Here</a>
                    </li>
                    <li class="nav-item">
           ...
           <?php $businesslist1 =\App\BusinessQuestionEtiquete::all()->where('status', 1);?>
            ...
            <section class="zigzag-red-sec">
              ...
              <?php $__currentLoopData = $businesslist2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li><?php echo $list2->description; ?></li>
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        </div>
...
<?php echo $__env->make('masters.frontmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\honeyluxe-front\resources\views/frontend/pages/businessEtiquete.blade.php ENDPATH**/ ?>