...
<?php $__env->startSection('header_title', 'Blog Edit'); ?>
...
<div class="col-md-9 right-content">
   <div class="box multi_step_form">
      <form action="<?php echo e(route('client.blog.update')); ?>" method="post" enctype="multipart/form-data">
           <?php echo csrf_field(); ?>
...
<?php echo $__env->make('client.master.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/honeydevealakmal/public_html/resources/views/client/blog_edit.blade.php ENDPATH**/ ?>