    ...
    <div class="container-fluid">
      ...
      <div class="card card-default">
        ...
        <div class="card-body">
          ...
          <br><br>
          <a href="<?php echo e(route('addsilder')); ?>" class="btn btn-success">Add Slider</a>
          <hr>
                ...
                <div class="mdb-lightbox no-margin">
                  <?php $__currentLoopData = $slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <figure class="col-md-4">
                      <a href="<?php echo e(route('escort.slider-edit',$value->id)); ?>" data-size="1600x1067" title="Edit Slider">
...
<?php echo $__env->make('masters.frontmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/honeydevealakmal/public_html/resources/views/frontend/escort_dashboard/sliderview.blade.php ENDPATH**/ ?>