...
<aside class="control-sidebar UserASIDE control-sidebar-dark">
  ...
  <div class="UserImage text-center">
     <span class="logo-lg">
      <img src="<?php echo e(asset('public/logo.png')); ?>" class="img-fluid">
    </span>
...
<!-- /.control-sidebar --><?php /**PATH E:\xampp\htdocs\pumpMenubarGraph\resources\views/includes/sadmin-header.blade.php ENDPATH**/ ?>