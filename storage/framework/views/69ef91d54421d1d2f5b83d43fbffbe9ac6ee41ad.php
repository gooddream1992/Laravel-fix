...
<section class=" innerpage-banner">
            ...
            <div class="container">
                <div class="ban-text text-left">
                    <h1><?php echo e($trafic1->title); ?> <br>    
                        <span class="text-red"><?php echo e($trafic1->red_title); ?></span>
                    </h1>
                    <p><?php echo $trafic1->description; ?></p>
                    ...
                    <div class="row justify-content-center c-center">
                        <div class="col-lg-12">
                            <div class="large-title box-title">
                                ...
                                <p><?php echo $trafic2->description; ?></p>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <?php $__currentLoopData = $sxtraffics3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trafic3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                            <div class="sex-traffic-box c-center">
                               ...
                               <?php echo $trafic3->description; ?>dsadsa
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="box-title dark c-center mb-0">
                                <h2><?php echo e($trafic6->title); ?> <span style="color: red;"><?php echo e($trafic6->red_title); ?></span></h2>
...
<?php echo $__env->make('masters.frontmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/honeydevealakmal/public_html/resources/views/frontend/provider/frontSexTrafficking.blade.php ENDPATH**/ ?>