...
<a href="{{ url('escort/confirmation').'/'.$usersId }}">Confirm Your Login ID</a> -->
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey {{ $name }}, This Mail is for Verification of your Account</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              We're really excited for you to join as {{ $role == 2 ? "Escort" : "Client" }}! You're just one click away from verification for your account.
                            </td>
                          </tr>
                        </table>
                        ...
                        <![endif]--><a href="{{ route('client.email.verfication',['id'=>$usersId,'name'=>$name]) }}"
