<nav class="navbar navbar-inverse header">
        ...
        <a href="<?php echo e(url('/')); ?>" class="white-btn">Dashboard</a>
                ...
                <div class="header-menu-right desktop-menu">
                    <nav class="menu">
                        <ul>
                            ...
                            <li><a class=" btn red-small client-login" href="#">Join Now</a></li>
                        </ul>
                        <div class="hamburger m-hidden"><span></span></div>
                        <div class="dimmer"></div>
                    </nav>
...
<?php /**PATH E:\xampp\htdocs\honeyluxe\resources\views/frontend/includes/nav.blade.php ENDPATH**/ ?>