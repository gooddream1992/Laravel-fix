      ...
      <div class="card card-default">
       <a href="{{url('/home')}}" class="btn btn-primary">Back</a><hr>
        ...
        <div class="card-body">
          ...
          <form role="form" method="POST" action="{{ route('escort-service-location-add') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
                        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="form-group sip_mt">
                      ...
                      <div class="selct_2_alska">
                      	<input type="hidden" name="usersId" placeholder="Name" value="{{ $users->id }}" class="form-control">
                        <input type="text" name="name" placeholder="Name" value="{{ $users->name }}" class="form-control" readonly>
                      </div>
                    </div>
                  </div>
                   <div class="col-lg-12">
