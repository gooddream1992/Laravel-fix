<!-- Hello ,
Thank You for Registration on Honey Luxe. Please Make your register ID As Confirm By click on the Link 
<a href="<?php echo e(url('escort/confirmation').'/'.$usersId); ?>">Confirm Your Login ID</a> -->
            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Welcome to Honey Luxe!</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey <?php echo e($name); ?>, This Mail is for Verification of your Account</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              We're really excited for you to join as <?php echo e($role == 2 ? "Escort" : "Client"); ?>! You're just one click away from verification for your account.
                            </td>
                          </tr>
                        </table>
                        ...
                        <![endif]--><a href="<?php echo e(route('client.email.verfication',['id'=>$usersId,'name'=>$name])); ?>"
                        style="background-color:#41CC00;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;text-shadow: -1px -1px #47A54B;line-height:38px;text-align:center;text-decoration:none;width:190px;-webkit-text-size-adjust:none;mso-hide:all;">Verify Your Email Account!</a></div>
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Thanks so much,</p>
                              <p class="body-signature" style="background-color: black;"><img src="https://honeydeve.alakmalak.ca/public/uploads/21595727067.png" alt="Company Name" style="display: block; margin-left: auto; margin-right: auto; width: 50px; height: 50px"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
...
</html><?php /**PATH /home/honeydevealakmal/public_html/resources/views/verfication.blade.php ENDPATH**/ ?>