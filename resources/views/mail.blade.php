                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey {{ $name }}, thanks for signing up</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              We're really excited for you to join as {{ $role == 2 ? "Escort" : "Client" }}! You're just one click away from activate your account.
                            </td>
                          </tr>
                        </table>
                        ...
                        <![endif]--><a href="{{ url('escort/confirmation').'/'.$usersId.'/'.$name }}"
