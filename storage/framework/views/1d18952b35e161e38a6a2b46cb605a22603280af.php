                ...
                <div class="auth-box">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                           ...
                           <form method="POST" action="<?php echo e(url('storenewpassword')); ?>" id="form">
                                   <?php echo csrf_field(); ?>
...
<?php /**PATH /home/honeydevealakmal/public_html/resources/views/frontend/pages/newpassword.blade.php ENDPATH**/ ?>