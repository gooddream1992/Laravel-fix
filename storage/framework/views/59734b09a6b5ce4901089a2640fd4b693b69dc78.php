...
<?php $__env->startSection('header_title', 'Blog Detail'); ?>
...
<div class="row">
  <div class="leftcolumn">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <a href="<?php echo e(route('client.blog.delete',$blog->id)); ?>" class="btn btn-primary" style="width: 140px; align-content: center;">
...
<?php echo $__env->make('client.master.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/honeydevealakmal/public_html/resources/views/client/blog_details.blade.php ENDPATH**/ ?>