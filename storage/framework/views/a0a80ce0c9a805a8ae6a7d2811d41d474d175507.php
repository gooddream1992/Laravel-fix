...
<li class="nav-item has-treeview">
     ...
     <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('admin.social.media')); ?>" class="nav-link">
         ...
         <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo e(route('testimonial.list')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('testimonial.delete-page')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
                <p>Reviews</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('admin.escort.profile.request')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
                <p>Escort Profile Request</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo e(route('admin.escort.request.deny.reason')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('faq.client.escort.view')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
...
<li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
             ...
             <li class="nav-item">
              <a href="<?php echo e(route('admin.privacyview')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
             ...
             <li class="nav-item">
              <a href="<?php echo e(route('admin.copy.view')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
                <p>Copy Right</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo e(route('admin.acceptable.view')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
                <p>Acceptable Usage</p>
              </a>
            </li>
             <li class="nav-item">
              <a href="<?php echo e(route('admin.disclaimerview')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
                <p>Disclaimer</p>
              </a>
            </li>           
 ...
 <li class="nav-item has-treeview">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
             <li class="nav-item">
              <a href="<?php echo e(route('local.resources.admin.view')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
                <p>Local Resources Listing</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo e(route('purchase.marketing.admin.view')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="<?php echo e(route('admin.blogging.index')); ?>" class="nav-link">
                <i class="fas fa-arrow-circle-right nav-icon"></i>
...
<?php endif; ?>
  ...
  <!-- /.sidebar -->
</aside><?php /**PATH /home/honeydevealakmal/public_html/resources/views/includes/sadmin-menu-sidebar.blade.php ENDPATH**/ ?>