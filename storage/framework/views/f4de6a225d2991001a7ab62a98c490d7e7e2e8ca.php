<?php $__env->startSection('title', __('New Vendor Add')); ?>
...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      ...
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title FormTitle">New Vendor Add</h3>
   ...
   <form role="form" method="POST" action="<?php echo e(url('vendor/add')); ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group sip_mt">
                      ...
                      <div class="selct_2_alska">
                        <input type="text" name="vendorDue" value="0">
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-12">
...
<?php echo $__env->make('masters.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pump\resources\views/admin/vendor/vendorAdd.blade.php ENDPATH**/ ?>