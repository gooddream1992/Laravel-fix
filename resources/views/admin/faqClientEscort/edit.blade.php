      ...
      <div class="container-fluid">
         ...
         <div class="card card-default">
            ...
            <div class="card-body">
               ...
               <hr>
               <form role="form" method="POST" action="{{ route('faq.client.escort.update')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                           ...
                           <div class="col-lg-12">
                              <div class="form-group sip_mt">
                                 ...
                                 <div class="selct_2_alska">
                                    <input name="question" type="text" value="{{ $value->question }}">
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="form-group sip_mt">
                                 ...
                                 <div class="selct_2_alska">
                                    <select class="form-control" name="roleType">
                                    	...
                                    	<option value="2" @if($value->roleType == 2) selected @endif>
                                    		Escort
                                    	</option>
                                    	<option value="3" @if($value->roleType == 3) selected @endif>
                                    		Client
                                    	</option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="form-group sip_mt">
                                 ...
                                 <div class="selct_2_alska">
                                    <textarea class="textarea" name="answer">{{ $value->answer }}</textarea>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-12">
