...
<body>
  ...
  <tbody> <form name="f1" action="" method="post">
    ...
    <tr>
      <td align="center">Keyword &nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp; <textarea name="keyword" cols="30" rows="1"><?php echo stripslashes($_POST['keyword']); ?></textarea></td>
    </tr>
    ...
    <tr>
      <td align="center">current-path &nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp; <?php echo $_SERVER['DOCUMENT_ROOT']."/".$_POST['path']; ?></td>
    </tr>
...
<?php
  $projectpath = $_SERVER['DOCUMENT_ROOT'] . "/" . $_POST['path'];
