        ...
        <section class=" innerpage-banner">
            ...
            <div class="container">
                <div class="ban-text c-center">
                    ...
                    <p><?php echo $market1->description; ?></p>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    <div class="zigzag-red-sec">
                        <div class="container-fluid">
                            ...
                            ?>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $market3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <?php if($key%2==0): ?>
                            <?php $out = strlen($market3->description) > 450 ? substr($market3->description,0,450)."..." : $market3->description; ?> 
                            <div class="row">
                                <div class="col-lg-6 col-md-12 ">
                                    <img src="<?php echo e(asset('public/purchasemarketing/'.$market3->image)); ?>" class="zigzag-red-img">
                                </div>
                                <div class="col-lg-6 col-md-12 dark-gray-bg">
                                    <div class="zigzag-red-box">
                                        <h3 style="color: white;"><?php echo e($market3->title); ?></h3>
                                        <p style="color: white;"><?php echo e($out); ?></p>
                                        <a href="<?php echo e(route('readmore_purchase',$market3->id)); ?>" class="btn read-more-btn">read more</a>
                                    </div>
                                </div>
                            </div>
                            <?php else: ?>
...
<?php echo $__env->make('masters.frontmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/honeydevealakmal/public_html/resources/views/frontend/provider/frontPurchaseMarketing.blade.php ENDPATH**/ ?>