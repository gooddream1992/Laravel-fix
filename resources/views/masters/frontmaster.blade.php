            ...
            function getCities() {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        @if (isset($city_id) || isset($state_id))
                            cityId = {{ $city_id ?? $state_id }}
                        @endif
                        $('#citySelect').text(' ');
                        $('#citySelectMob').text(' ');
    ...
    $(document).ready(function(){
        ...
        $(document).ready(function(){
           $('#service_type').on('change',function(){
                if(this.value == 1){
                    $('#formId').attr('action', "{{ url('filter/search/escort?servicetype=Escort') }}");
                }else if(this.value == 2){
                    $('#formId').attr('action', "{{ url('filter/search/escort?servicetype=BDSM') }}");
                }else if(this.value == 3){
                    $('#formId').attr('action', "{{ url('filter/search/escort?servicetype=Massage') }}");
                }else{
                    $('#formId').attr('action', "{{ url('filter/search/escort') }}");
                }
           });
        });
</script>       
