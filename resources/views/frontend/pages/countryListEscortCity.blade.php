...
$sss = isset($seo['seo']) ? strip_tags($seo['seo']) : '';

$es_ids = array();
foreach($tour_search as $tour_val){
    $es_ids[] = $tour_val->escortId;
}
        $escorts = \App\User::where([
            ['roleStatus','=', 2],
            ['request','=', 1],
            ['country','=', $country_id],
            ['state','=', $city_id]
        ])
        ->whereNotIn('id',$es_ids)
        ->get();
    ...
    <section class="home-escorts" style="height: 100% !important;">
        <div class="container">
            <div class="row justify-content-lg-center justify-content-md-center escort-row">
                    ...
                    @foreach($tour_search as $tour_val)
                    @php
                        $users_touring = DB::table('users')->where('id',$tour_val->escortId)->get();
                        $touring = \App\ProfileTour::where('escortId',$tour_val->escortId)
            ...
            <div class="col-lg-3 col-6">
                    <a href="{{url('profile/'.$tour_val->escortId.'/'.str_replace(' ','-',$users_touring[0]->name))}}">
                <div class="our-escort-box is-available">
                    @php
                        $profile_image = NULL;
                        $profile_image_arr = DB::table('profile_images')->where('status','5')->where('escortId',$tour_val->escortId)->get();
                    ...
                    <div class="overlay-top">
                        <div class="text">
                            <h4>
                                @foreach($users_touring as $userVal)
                                    {{$userVal->name}}
                                @endforeach
                            </h4>
                            <span class="location">
                                <?php
                                    foreach($users_touring as $userVal){
                                        $statecount=\App\State::all()->where('id', $userVal->state);
                                    }
                                ?>
                                @if($statecount->count()<1)
                                    Not Found
                                @else
                                    {{\App\State::find($users_touring[0]->state)->state}}
                                @endif
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="overlay-bottom {{ isset($touring->startDate) && $touring->startDate!='' ? '' : 'bottom-without-tour' }}">
                        <div class="text">
                            ...
                            @endphp
                            @if($tour_val->city != $users_touring[0]->state)
                                <h3>
                            ...
                            <table class="escort-profile-details">
                                <tr>
                                    ...
                                    <td>
                                        @foreach($users_touring as $userVal)
                                            {{ isset($userVal->city) ? $userVal->city : '' }}
                                        @endforeach
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        @foreach($users_touring as $userVal)
                                            @if($userVal->serviceArea==1)
                                                In Call
                                            @elseif($userVal->serviceArea==2)
                                                Out Call
                                            @elseif($userVal->serviceArea==3)
                                                In call & Out Call
                                            @endif
                                        @endforeach
                                ...
                                <tr>
                                    ...
                                    @php
                                        ...
                                        // }
                                        $profile_Rate_one = \App\ProfileRate::where('escortId','=',$tour_val->escortId)->where('price','!=','')->get();
                                        $profile_Rate_both = \App\ProfileRate::where('escortId','=',$tour_val->escortId)->where('price','!=','')->select('price')->get();
                                        if(!empty($profile_Rate_both->toArray())){
                                            $profile_Rate_both = min(json_decode(json_encode(($profile_Rate_both)),true));
                                        }
                                    @endphp
            ...
            @endforeach
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="our-escort-box is-available">
                        ...
                        <div class="overlay-top">
                            <div class="text">
                                ...
                                <span class="location">
                                    ...
                                    @else
                                    @php
                                        $state_name = \App\State::find($escort->state)->state;
                                    @endphp
                                        {{$state_name}}
                                    @endif
                                </span>
                        ...
                        <div class="overlay-bottom {{ isset($touring->startDate) && $touring->startDate!='' ? '' : 'bottom-without-tour' }} {{ $escort->state == $city_id ? 'bottom-without-tour' : '' }}">
                            <div class="text">
                                <h3>
                                     @php
                                        $statecount=\App\State::all()->where('id', $touring->city)->first();
                ...
                @endforeach
                <?php 
                // $tourescorts= \App\User::all()->whereIn('id', $tour_arr)->where('request','=', 1); 
                $tourescorts = array();
                ?> {{-- SMPEDIT 01-10-2020 --}}
                @foreach($tourescorts as $tour_escort_detail)
                <div class="col-lg-3 col-6">
                        <a href="{{url('profile/'.$tour_escort_detail->id)}}">
                    <div class="our-escort-box is-available">                        
                        @if($tour_escort_detail->photo==NULL)
                            <img src="{{asset('public/blankphoto.png')}}" class="w-100">
                        @else
                            <img src="{{asset('public/uploads/'.$tour_escort_detail->photo)}}" class="w-100"/>@endif
                        <div class="overlay-top">
                            <div class="text">
                                <h4>{{$tour_escort_detail->name}}</h4>
                                <span class="location"><?php $statecount=\App\State::all()->where('id', $tour_escort_detail->city);?>@if($statecount->count()<1) Not Found @else {{\App\State::find($tour_escort_detail->city)->state}} @endif</span>
                            </div>
                        </div>
                        <div class="overlay-bottom {{ isset($tour_id_wise[$tour_escort_detail->id]['startDate']) && $tour_id_wise[$tour_escort_detail->id]['startDate'] !='' ? 'bottom-without-tour' : ''}}">
                            <div class="text">
                                <h3>
                                    {{ $tour_id_wise[$tour_escort_detail->id]['startDate'] }}
                                    TO
                                    {{ $tour_id_wise[$tour_escort_detail->id]['endDate'] }}
                                </h3>
                                ...
                                <table class="escort-profile-details">
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                $citycount=\App\City::all()->where('id', $tour_escort_detail->suburb);
                                            ?>
                                            @if($citycount->count()<1) Not Found @else {{\App\City::find($tour_escort_detail->suburb)->city}} @endif</td>
                                    </tr>
                                    <tr>
                                        <td>Service Area</td>
                                        <td>@if($tour_escort_detail->serviceArea==1) In Call @else Out Call @endif</td>
                                    </tr>
                                    <tr>
                                        <td>Price</td>
                                        <td>${{$tour_escort_detail->price}}</td>
                                    </tr>
                                    <tr>
                                        <td>Height</td>
                                        <td>{{$tour_escort_detail->height}} "</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        @if($tour_escort_detail->activation==1)
                        <div class="availability">
                            <h5>Available Now</h5>
                        </div>
                        @else
                ...
                <div class="row justify-content-lg-center justify-content-md-center justify-content-center ">
                    @foreach($professionals as $professonal)
                        <div class="col-lg-4 col-md-6 col-6 col-6">
                            <a href="{{url('multi/page?url=mul-reviews&country='.$ex_url[0].'&city='.$ex_url[1])}}">
                    ...
                    @foreach($professionals as $professonal)
                        <div class="col-lg-4 col-md-6 col-6 col-6">
                            <a href="{{url('multi/page?url=mul-tours&country='.$ex_url[0].'&city='.$ex_url[1])}}">
                                <div class="platform-box">
                                    <div class="img-area">
                    ...
                    @foreach($professionals as $professonal)
                        <div class="col-lg-4 col-md-6 col-6 col-6">
                            <a href="{{url('multi/page?url=mul-blogs&country='.$ex_url[0].'&city='.$ex_url[1])}}">
                                <div class="platform-box">
                                    <div class="img-area">
                    ...
                    @foreach($professionals as $professonal)
                        <div class="col-lg-4 col-md-6 col-6 col-6">
                            <a href="{{url('multi/page?url=mul-client-logs&country='.$ex_url[0].'&city='.$ex_url[1])}}">
                                <div class="platform-box">
                                    <div class="img-area">
            ...
            <?php // $country=\App\Country::all();?>
                ...
                {{-- <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box">
                        ...
                        <a href="{{url('country/list/escort/'.$country.'/'.$city_id.'/1')}}" class="city-btn">Male</a>
                    </div>
                </div>  
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box">
                        <img src="{{asset('public/blankphoto.png')}}" class="w-100">
                        <a href="{{url('country/list/escort/'.$country.'/'.$city_id.'/2')}}" class="city-btn">Female</a>
                    </div>
                </div>  
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box">
                        <img src="{{asset('public/blankphoto.png')}}" class="w-100">
                        <a href="{{url('country/list/escort/'.$country.'/'.$city_id.'/3')}}" class="city-btn">Trans Gender</a>
                    </div>
                </div>  
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box" >
                        <img src="{{asset('public/blankphoto.png')}}" class="w-100">
                        <a href="{{url('country/list/escort/'.$country.'/'.$city_id.'/4')}}" class="city-btn">Gay</a>
                    </div>
                </div>  
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box" style="min-height: 170px !important;">
                        <img src="{{asset('public/uploads/Male.jpg')}}" class="w-100">
                        <a href="{{url('country/'.$country.'/'.$city_name.'/Male')}}" class="city-btn">Male</a>
                    </div>
                </div>  
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box" style="min-height: 170px !important;">
                        ...
                        <a href="{{url('country/'.$country.'/'.$city_name.'/Female')}}" class="city-btn">Female</a>
                    </div>
                </div>  
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box" style="min-height: 170px !important;">
                        ...
                        <a href="{{url('country/'.$country.'/'.$city_name.'/Gay')}}" class="city-btn">Gay</a>
                    </div>
                </div>  
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                    <div class="location-box" style="min-height: 170px !important;">
                        ...
                        <a href="{{url('country/'.$country.'/'.$city_name.'/transgender')}}" class="city-btn">Trans Gender</a>
                    </div>
                </div>  
            </div>
        </div>
