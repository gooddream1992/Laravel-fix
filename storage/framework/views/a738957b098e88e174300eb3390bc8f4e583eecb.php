...
<section class="auth-page sign-in-page auth-signin-page" style="background-image: url('<?php echo e(asset('public/uploads/no-fake-profile-bg.jpg')); ?>'); background-size:cover;background-position: center;">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" >
                        ...
                        <div class="form-group mb-0">
                            <div class="new-account-user">
                                ...
                                <a class="btn red-small c-center" href="<?php echo e(url('client/signup')); ?>" style="margin-left: 10px;">Signup</a>
                            </div>
                        </div>
                    </form>
                </div>
