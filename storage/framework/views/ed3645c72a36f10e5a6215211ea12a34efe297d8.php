...
<form method="POST" action="<?php echo e(route('profile.stats.update')); ?>">
    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="hair">
                                    <option></option>
                                    <option value="1" <?php echo e(($escort->hair == 1) ? 'selected' : ''); ?>>1</option>
                                    <option value="2" <?php echo e(($escort->hair == 2) ? 'selected' : ''); ?>>2</option>
                                    <option value="3" <?php echo e(($escort->hair == 3) ? 'selected' : ''); ?>>3</option>
                                </select> 
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="eyes">
                                    <option></option>
                                    <option name="1" <?php echo e(($escort->eyes == 1) ? 'selected' : ''); ?>>1</option>
                                    <option name="2" <?php echo e(($escort->eyes == 2) ? 'selected' : ''); ?>>2</option>
                                    <option name="3" <?php echo e(($escort->eyes == 3) ? 'selected' : ''); ?>>3</option>
                                </select> 
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="body_shape">
                                    <option></option>
                                    <option value="1" <?php echo e(($escort->bodyShape == 1) ? 'selected' : ''); ?>>1</option>
                                    <option value="2" <?php echo e(($escort->bodyShape == 2) ? 'selected' : ''); ?>>2</option>
                                    <option value="3" <?php echo e(($escort->bodyShape == 3) ? 'selected' : ''); ?>>3</option>
                                </select> 
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="nationality">
                                    <option></option>
                                    <option value="1" <?php echo e(($escort->nationality == 1) ? 'selected' : ''); ?>>1</option>
                                    <option value="2" <?php echo e(($escort->nationality == 2) ? 'selected' : ''); ?>>2</option>
                                    <option value="3" <?php echo e(($escort->nationality == 3) ? 'selected' : ''); ?>>3</option>
                                </select> 
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
...
<?php echo $__env->make('masters.profileMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/honeydevealakmal/public_html/resources/views/frontend/escort_dashboard/new/profileStats.blade.php ENDPATH**/ ?>