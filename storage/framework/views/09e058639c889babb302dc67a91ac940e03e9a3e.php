<!DOCTYPE html>
<head>
  <title><?php echo e(__('PUMP: Accounting Software')); ?></title>
  <!-- bootstrap-css -->
...
<body style="background-image: url('/pump/public/bg.jpg'); background-size: cover;background-repeat: no-repeat;background-attachment: fixed;">

    <div class="w3layouts-main">
      <h2><img src="<?php echo e(asset('public/logo.png')); ?>" style="width: 50%;"><br><?php echo e(__('Pump Accounting')); ?></h2>
...
</html><?php /**PATH E:\xampp\htdocs\pumpMenubarGraph\resources\views/welcome.blade.php ENDPATH**/ ?>