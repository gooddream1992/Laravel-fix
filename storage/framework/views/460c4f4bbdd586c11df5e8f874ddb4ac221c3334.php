...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      ...
      <div class="card-body">
          <form name="cart" id="cart"  action="<?php echo e(url('data/entry/others/store')); ?>" method="POST">
...
<?php echo $__env->make('masters.masterinvoice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pump\resources\views/admin/data_entry/dataEntryOthers.blade.php ENDPATH**/ ?>