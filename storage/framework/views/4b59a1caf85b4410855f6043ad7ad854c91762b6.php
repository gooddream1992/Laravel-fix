                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(url('user/store')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Select Branch')); ?></label>

                            <div class="col-md-6">
                               <select name="branchId" class="form-control">
                                <?php $branches= \App\Branch::all();?>
                                <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                   <option value="<?php echo e($branch->id); ?>"><?php echo e($branch->branchName); ?></option>
...
<?php echo $__env->make('masters.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\pump\resources\views/admin/general_setting/register.blade.php ENDPATH**/ ?>