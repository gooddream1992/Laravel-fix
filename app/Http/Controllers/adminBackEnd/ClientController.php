...
class ClientController extends Controller
{
    ...
    public function comments($escortid){

      return view('frontend.provider.comments', compact('escortid'));
    }
    public function likes($escortid){

      return view('frontend.provider.likes', compact('escortid'));
    }
}