            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Honey Luxe!</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey <?php echo e($name); ?>,</div>
                        ...
                        <![endif]--><a href="<?php echo e(url('resetpasswordbyemail').'/'.$usersId.'/'.$name); ?>"
...
</html><?php /**PATH /home/honeydevealakmal/public_html/resources/views/clientforgotpassword.blade.php ENDPATH**/ ?>